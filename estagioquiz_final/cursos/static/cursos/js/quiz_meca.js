...
// Ativa o botão de avançar assim que o utilizador escolhe uma opção
if (formulario) {
...
function atualizarProgresso() {
    ...
    if (progressoPreenchido) {
        ...
        progressoPreenchido.style.width = porcentagem + "%";
    }
}
...
function mostrarResultado() {
    ...
    if (resultDescription) {
        resultDescription.innerText = descricao[melhorArea] || "";
    }
}
...
function reiniciarQuiz() {
    ...
    const primeiraQuestao = document.querySelector('.container-questao[data-question="1"]');
    if (primeiraQuestao) {
